...
public class BookListRecyclerAdapter extends RecyclerView.Adapter<BookListRecyclerAdapter.ItemViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull BookListRecyclerAdapter.ItemViewHolder itemViewHolder, int i) {
