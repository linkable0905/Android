...
public class GaugeCategoryRecyclerAdapter extends RecyclerView.Adapter<GaugeCategoryRecyclerAdapter.ItemViewHolder> {
    // adapter에 들어갈 list 입니다.
    private ArrayList<Data> listData = new ArrayList<>();

    @NonNull
    @Override
    public GaugeCategoryRecyclerAdapter.ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // LayoutInflater를 이용하여 전 단계에서 만들었던 item.xml을 inflate 시킵니다.
        // return 인자는 ViewHolder 입니다.
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.search_item, parent, false);
        return new GaugeCategoryRecyclerAdapter.ItemViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull GaugeCategoryRecyclerAdapter.ItemViewHolder itemViewHolder, int i) {
    ...
    class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        void onBind(final Data data, GaugeCategoryRecyclerAdapter.ItemViewHolder viewHolder, final int index) {
